...
<div ng-app="myShoppingList" ng-cloak ng-controller="myCtrl" class="w3-card-2 w3-margin" style="max-width:400px;">
    ...
    <ul class="w3-ul">
        <li ng-repeat="x in products" class="w3-padding-hor-16">@{{x}}<span ng-click="removeItem($index)" style="cursor:pointer;
        " class="w3-right w3-margin-right glyphicon glyphicon-remove"></span></li>
    </ul>
